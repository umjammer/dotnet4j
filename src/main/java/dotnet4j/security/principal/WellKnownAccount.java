...
class WellKnownAccount {
    ...
    public static WellKnownAccount lookupByType(WellKnownSidType sidType) {
        for (WellKnownAccount acct : accounts) {
    ...
    public static WellKnownAccount lookupBySid(String s) {
        for (WellKnownAccount acct : accounts) {
            if (Utilities.equals(acct.Sid, s))
                return acct;
        }
        return null;
    }
    ...
    public static WellKnownAccount lookupByName(String s) {
        for (WellKnownAccount acct : accounts) {
            if (Utilities.equals(acct.Name, s))
                return acct;
        }
        return null;
    }
    ...
    public static WellKnownAccount lookupBySddlForm(String s) {
        for (WellKnownAccount acct : accounts) {
            if (Utilities.equals(acct.SddlForm, s))
                return acct;
        }
        return null;
    }

    private static final WellKnownAccount[] accounts = new WellKnownAccount[] {
        // @formatter:off
        ...
        new WellKnownAccount() {{ WellKnownValue = WellKnownSidType.AccountAdministratorSid; IsAbsolute = false; Rid = "500"; Sid = "S-1-5-21-%s-500"; SddlForm = "LA";}},
        new WellKnownAccount() {{ WellKnownValue = WellKnownSidType.AccountGuestSid; IsAbsolute = false; Rid = "501"; Sid = "S-1-5-21-%s-501"; SddlForm = "LG";}},
        new WellKnownAccount() {{ WellKnownValue = WellKnownSidType.AccountKrbtgtSid; IsAbsolute = false; Rid = "502";}},
        new WellKnownAccount() {{ WellKnownValue = WellKnownSidType.AccountDomainAdminsSid; IsAbsolute = false; Rid = "512"; Sid = "S-1-5-21-%s-512"; SddlForm = "DA";}},
        new WellKnownAccount() {{ WellKnownValue = WellKnownSidType.AccountDomainUsersSid; IsAbsolute = false; Rid = "513"; Sid = "S-1-5-21-%s-513"; SddlForm = "DU";}},
        new WellKnownAccount() {{ WellKnownValue = WellKnownSidType.AccountDomainGuestsSid; IsAbsolute = false; Rid = "514"; Sid = "S-1-5-21-%s-514"; SddlForm = "DG";}},
        ...
        new WellKnownAccount() {{ WellKnownValue = WellKnownSidType.valueOf(66); IsAbsolute = false; Rid = "4096"; SddlForm = "LW";}},
        new WellKnownAccount() {{ WellKnownValue = WellKnownSidType.valueOf(67); IsAbsolute = false; Rid = "8192"; SddlForm = "ME";}},
        new WellKnownAccount() {{ WellKnownValue = WellKnownSidType.valueOf(68); IsAbsolute = false; Rid = "12288"; SddlForm = "HI";}},
        new WellKnownAccount() {{ WellKnownValue = WellKnownSidType.valueOf(69); IsAbsolute = false; Rid = "16384"; SddlForm = "SI";}},
        new WellKnownAccount() {{ WellKnownValue = WellKnownSidType.valueOf(74); IsAbsolute = false; Rid = "521"; SddlForm = "RO";}},
        new WellKnownAccount() {{ WellKnownValue = WellKnownSidType.valueOf(78); IsAbsolute = false; Rid = "574"; SddlForm = "CD";}},
        // @formatter:on
    };
}
