...
//        }
    ...
    /**
     * Wraps a future with one that will complete as canceled based on a
    ...
    public static <T> CompletableFuture<T> withCancellation(CompletableFuture<T> future, CancellationToken cancellationToken) {
        Objects.nonNull(future);
...
//        }
    ...
    /**
     * Wraps a future with one that will complete as cancelled based on a
     * cancellation token, allowing someone to await a task but be able to break
            ...
            return Async.usingAsync(
                    ...
                    () -> Async.awaitAsync(
                            ...
                            completedFuture -> {
                                ...
                                // Rethrow any fault/cancellation
                                // exception, even if we awaited
                                // above.
                                // But if we skipped the above if
                                // branch, this will actually yield
