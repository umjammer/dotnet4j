...
public enum AwaitExtensions {
     ...
     * @return An awaiter.
     */
    public static ExecutorAwaiter getAwaiter(Executor executor) {
     ...
     * @return An awaitable.
     */
    public static ExecutorAwaitable switchTo(Executor executor) {
    ...
    public static final class ExecutorAwaitable implements Awaitable<Void> {
        ...
        /**
         * A value indicating whether the awaitable will always call the caller
         * to yield.
         */
    ...
    public static final class ExecutorAwaiter implements Awaiter<Void>, CriticalNotifyCompletion {
        ...
        /**
         * A value indicating whether {@link #isDone()} should always return
         * {@code false}.
         */
        private final boolean alwaysYield;
